...
parser.add_argument('--prompt_path', type=str, help='Path to the prompt file.', required=False)
parser.add_argument('--prompt', type=str, help='Prompt text.', required=False)
