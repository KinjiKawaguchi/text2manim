...
_runtime_version.ValidateProtobufRuntimeVersion(
    _runtime_version.Domain.PUBLIC, 5, 28, 2, "", "text2manim/v1/worker.proto"
)
...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "text2manim.v1.worker_pb2", _globals
)
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals[
        ...
        b"ZHgithub.com/KinjiKawaguchi/text2manim/api/pkg/text2manim/v1;text2manim_v1"
    )
